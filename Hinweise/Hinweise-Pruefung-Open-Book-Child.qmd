...
- Der *Tolerenzbereich* einer Lösung liegt bei 5% des Wertes der Musterlösung *oder* bei `0.1*sd(y)`, je nachdem welcher der beiden Werte kleiner ist (y: vorherzusagende Variable).
