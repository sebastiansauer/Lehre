...
- Achten Sie darauf, R und R-Pakete sowie R-Studio *in aktueller Version* zu verwenden. Das Verwenden älterer Versionen kann (in seltenen Fällen) zu abweichenden Lösungen führen. Im Zweifel beziehen sich alle Aufgaben auf die jweils aktuellste Version der verwendeten Software.
...
- Nutzen Sie die Software *Stan* in Form des R-Paket `rstanarm` für Regressionsmodelle auf Basis der Bayes-Methode.
