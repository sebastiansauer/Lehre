...
Gegenstand dieser Prüfungsform ist eine *Projektarbeit*.
...
2. Der Name jeder eingereichte Datei muss wie folgt lauten: `Nachname_Vorname_Matrikelnummer_Dateiart.Endung`. Beispiel: `Sauer_Sebastian_0123456_Prognose.csv` bzw. `Sauer_Sebastian_0123456_Analyse.qmd`.
...
2. Der Name jeder eingereichten Datei muss wie folgt lauten: `Nachname_Vorname_Matrikelnummer_Dateiart.Endung`. Beispiel: `Sauer_Sebastian_0123456_Prognose.csv` bzw. `Sauer_Sebastian_0123456_Analyse.Rmd`.
=======
>>>>>>> 3c6fb6218773e3b44417b48bc57337263526d270
...
Das Dokument mischt drei Textarten: R-Syntax, R-Ausgaben sowie Prosa (Ihre Erklärung zu Ihrer Analyse).
...
**Alles, was Sie tun, Datenvorverarbeitung, Modellierung und Anwenden, muss transparent sein.** Im Übrigen lautet die Aufgabe: 
